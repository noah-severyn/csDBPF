...
namespace csDBPF {
	...
	public class DBPFUnitTests {
		...
		[TestClass]
		public class DBPFCompressionTests {
		...
		[TestClass]
		public class DBPFPropertyTests {
			[TestMethod]
			...
			public void Test_062_DBPFPropertyString() {
				...
				DBPFProperty prop_file = DBPFProperty.DecodeExemplarProperty(DBPFCompressionTests.decompresseddata, 37);

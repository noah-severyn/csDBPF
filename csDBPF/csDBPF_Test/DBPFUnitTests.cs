...
namespace csDBPF_Test {
	...
	public class DBPFUnitTests {
		...
		public class _02x_DBPFCompression {
			...
			public static byte[] notcompresseddata = new byte[] { 0x14, 0x00, 0x00, 0x10, 0x50, 0x00, 0x61, 0x00, 0x72, 0x00, 0x6B, 0x00, 0x73, 0x00, 0x20, 0x00, 0x41, 0x00, 0x75, 0x00, 0x72, 0x00, 0x61, 0x00, 0x20, 0x00, 0x28, 0x00, 0x62, 0x00, 0x79, 0x00, 0x20, 0x00, 0x43, 0x00, 0x6F, 0x00, 0x72, 0x00, 0x69, 0x00, 0x29, 0x00 };
			...
			public void Test_021_DBPFCompression_GetDecompressedSize() {
				Assert.AreEqual((uint) 44, DBPFCompression.GetDecompressedSize(notcompresseddata));
		...
		public class _1xx_DBPFFile {
			...
			public void Test_110b_ParseLTEXTEntries() {
				string ltext = DBPFEntry.DecodeEntry_LTEXT(_02x_DBPFCompression.notcompresseddata);

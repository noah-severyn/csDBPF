...
namespace csDBPF_Test {
	...
	public class DBPFUnitTests {
		internal class TestArrays {
			//Sample data from z_DataView - Parks Aura.dat --- IN BINARY FORM
		...
		public class _06x_DBPFProperty {
			...
			public void Test_061a_DBPFPropertyString_Binary() {
				...
				DBPFProperty prop_file = DBPFProperty.DecodeExemplarProperty_Binary(TestArrays.decompresseddata_b, 37);
